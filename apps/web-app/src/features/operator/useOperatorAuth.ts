...
interface StartSessionResponse {
  id: number;
  equipment: OperatingEquipment | null;
}
...
export function useOperatorAuth(deviceId: string | null) {
  ...
  const [operatingEquipment, setOperatingEquipment] = useState<OperatingEquipment | null>(null);
  ...
  const startShift = useCallback(async () => {
    ...
    try {
      ...
      setOperatingEquipment(sessionData.equipment ?? null);
