...
| `413 Content Too Large` al importar un KML/GeoJSON de geocercas grande      | `express.json()` sin límite explícito usa el default de 100kb - no tiene relación con Google/el navegador | Ya subido a `20mb` (`app.ts`) - confirmar que el backend esté en la versión más reciente                          |
